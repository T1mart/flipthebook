...
function updateBar() {
  let nav = document.querySelector("#navParam");
...
<template>
  <nav id="navParam" class="activated">
...
#navParam .openButton svg line {
  transition: all 0.7s ease-out;
}

#navParam.activated .openButton svg line:nth-child(1) {
  transform: translateX(35%) rotate(45deg);
}

#navParam.activated .openButton svg line:nth-child(2) {
  transform: scaleX(0);
}

#navParam.activated .openButton svg line:nth-child(3) {
  transform: translateY(35%) translateX(-35%) rotate(-45deg);
}

#navParam .parametersIcons {
  opacity: 0;
  width: 54px;
  height: 54px;
  border-radius: 10px;
...
#navParam.activated .parametersIcons {
  opacity: 1;
}
